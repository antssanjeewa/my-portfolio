...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="bg-card border border-border w-full max-w-7xl rounded-3xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col"
      >
        <div
          class="sticky top-0 bg-card z-20 border-b border-border px-8 py-6 flex items-center justify-between rounded-t-3xl"
        >
        ...
        <div class="flex-1 overflow-y-auto lg:overflow-hidden flex flex-col lg:flex-row">
          ...
          <div
            class="w-full lg:w-5/12 bg-muted/30 relative flex items-center justify-center p-8 border-b lg:border-b-0 lg:border-r border-border lg:h-full lg:overflow-y-auto"
          >
            <div class="w-full max-w-md space-y-6">
              ...
              <div v-if="project.link" class="flex gap-3">
                <a
                  :href="project.link"
                  target="_blank"
